export const translations = {
  en: {
    ...
    footer: {
      ...
      copyright: "© 2022-2026 Si-Gong Plan. All rights reserved.",
      location: "Location",
      contactInfo: "Contact",
  ...
  ko: {
    ...
    contact: {
      ...
      successMessage: "문의해 주셔서 감사합니다. 곧 답변 드리겠습니다."
    },
    footer: {
      social: "소셜 미디어 팔로우",
      copyright: "© 2022-2026 시공플랜. All rights reserved.",
      location: "위치",
      contactInfo: "연락처",
      address: "3404 Av. Prud'homme, Montréal, QC H4A 3H5",
      phone: "+1 (514) 814-6519",
  ...
  fr: {
    ...
    contact: {
      ...
      successMessage: "Merci pour votre demande. Nous vous répondrons bientôt."
    },
    footer: {
      social: "Suivez-nous",
      copyright: "© 2022-2026 Si-Gong Plan. Tous droits réservés.",

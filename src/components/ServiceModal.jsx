        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="bg-white rounded-lg shadow-2xl w-full max-w-lg relative max-h-[90vh] flex flex-col"
                >
                    {/* Close Button - Fixed relative to modal */}
                    <button
                        onClick={onClose}
                        className="absolute top-4 right-4 p-2 bg-white/80 hover:bg-white rounded-full z-10 shadow-sm transition-colors"
                    >
